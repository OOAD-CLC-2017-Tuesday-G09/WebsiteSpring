...
CREATE TABLE `news` (
  ...
  `datepost` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `news_document` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_news` (`news_id`),
  CONSTRAINT `document_news` FOREIGN KEY (`news_id`) REFERENCES `news` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-04-12 22:10:56
