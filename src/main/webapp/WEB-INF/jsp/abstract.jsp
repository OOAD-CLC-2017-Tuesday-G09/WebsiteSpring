            ...
            <div style="margin-left: 5px; margin-bottom: 10px;">
                <div class="ct_tin_display">
                    <div class="articleTitle">
                        <a href="indexe41c.html?ArticleId=bc474489-26ce-4997-a1c0-b37dce27b202">ABSTRACT DEADLINE EXTENSION: MARCH 19, 2017</a>
                    </div>
                    ...
                    <div class="articleContent">
                        <br />
<br />
<table border="0" cellpadding="0" cellspacing="0" style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px; margin-left: 0px; border-collapse: collapse; border-width: medium; border-style: none; margin-right: auto;">
    <tbody>
        <tr>
            <td colspan="3" valign="top" style="margin: 0px; width: 16cm; background-color: #002060; padding: 0cm 5.4pt;"></td>
        </tr>
        <tr>
            <td colspan="3" valign="top" style="margin: 0px; width: 16cm; padding: 0cm 5.4pt; background-color: #002060;"><span style="font-size: 14px; font-family: arial; color: #500050;" class="im">
            <p style="font-family: arial; margin: 0px 0px 0.0001pt; line-height: 25.5pt; background-color: #0b1d2f; vertical-align: top; text-align: center;"><strong><span style="font-size: 14px; color: #ffc063;"></span></strong></p>
            <p style="font-family: arial; margin: 0px 0px 0.0001pt; line-height: 25.5pt; vertical-align: top; text-align: center;"><strong><span style="font-size: 28px; color: #ffc063;">Abstract Deadline&nbsp;Extension:<br />
            March 19,&nbsp;2017</span></strong> </p>
            <p style="margin: 0px 0px 0.0001pt; line-height: 15pt; vertical-align: top; text-align: center;"><span style="font-size: 14px; font-family: arial; color: white;">&nbsp;</span><span style="font-size: 18px; color: white;">Your requests for an extension have been granted!</span></p>
            <p style="font-family: arial; margin: 0px 0px 0.0001pt; line-height: 19.5pt; vertical-align: top; text-align: center;"><span style="font-size: 14px; color: white;"><br />
            </span></p>
            <p style="font-family: arial; margin: 0px 0px 0.0001pt; line-height: 19.5pt; background-color: #0b1d2f; vertical-align: top; text-align: center;"><span style="font-size: 14px; color: white;"></span></p>
            </span>
            <p style="margin: 12pt 0cm 0.0001pt; line-height: 17.25pt; background-color: #0b1d2f; vertical-align: top;"><span style="font-size: 14px; font-family: arial; color: white;"></span></p>
            <p style="margin: 12pt 0cm 0.0001pt; line-height: 17.25pt; vertical-align: top;"><span style="font-size: 18px; color: #ffff00;"><span style="text-align: start; font-family: arial; font-size: 18px;">Dear all distinguished delegates,&nbsp;<br />
            ...
            </span></span><span style="font-size: large; font-family: arial; color: #ffff00;"><br />
            Click "Submit an Abstract" below for more information on suggested abstract topics and guidelines.</span></p>
            <span class="im" style="font-size: 14px; font-family: arial; color: #500050;">
            <p style="margin: 6pt 0cm; text-align: justify;"><span style="font-size: 14px; color: #ffffff;"></span><span style="font-size: 14px; color: #ffffff;"></span></p>
            </span><span class="im" style="color: #500050;">
            <p style="margin: 6pt 0cm; text-align: justify;"><span style="font-size: 14pt; color: #ffffff;"><br />
            </span></p>
            </span></td>
        </tr>
        <tr>
            <td valign="top" style="margin: 0px; width: 120.5pt; background-color: #002060; padding: 0cm 5.4pt;">
            <p style="margin: 6pt 0cm; text-align: center;">&nbsp;</p>
            </td>
            <td valign="top" style="margin: 0px; width: 219.7pt; background-color: #ffc000; padding: 0cm 5.4pt;">
            <p style="margin: 6pt 0cm; text-align: center;"><strong><a href="ArticleId/945864b5-165f-45a3-8e75-a9ba5ac1f9ef/index.html" target="_blank" data-saferedirecturl="https://www.google.com/url?hl=vi&amp;q=http://icsse2017.hcmute.edu.vn/ArticleId/945864b5-165f-45a3-8e75-a9ba5ac1f9ef/&amp;source=gmail&amp;ust=1488964221386000&amp;usg=AFQjCNE_xwiDIZk_wbcoxO_EA9ontqAH7A" style="color: #1155cc;"><span style="font-size: 18px;">SUBMIT AN ABSTRACT</span></a></strong></p>
            </td>
            <td valign="top" style="margin: 0px; width: 4cm; background-color: #002060; padding: 0cm 5.4pt;">
            <p style="margin: 6pt 0cm; text-align: center;">&nbsp;</p>
            </td>
        </tr>
        <tr>
            <td valign="top" style="margin: 0px; width: 120.5pt; background-color: #002060; padding: 0cm 5.4pt;">&nbsp;</td>
            <td valign="top" style="margin: 0px; width: 219.7pt; background-color: #002060; padding: 0cm 5.4pt;">&nbsp;</td>
            <td valign="top" style="margin: 0px; width: 4cm; background-color: #002060; padding: 0cm 5.4pt;">&nbsp;</td>
        </tr>
        <tr>
            <td valign="top" style="text-align: justify; margin: 0px; width: 120.5pt; background-color: #002060; padding: 0cm 5.4pt;" colspan="3"><span style="font-family: arial; font-size: 18px; color: #ffff00;">To be able to meet rest of the deadlines we have started with abstract evaluation process. Results of this process you can follow up on EasyChair conference system.</span></td>
        </tr>
    </tbody>
</table>
                    </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="/resources/Telerik.Web.UI.WebResource512a.jpg?type=rca&amp;guid=644f82c1-8cf8-4222-b8b8-9fabac3be9b2" style="height:50px;width:150px;border-width:0px;display:block;" />
