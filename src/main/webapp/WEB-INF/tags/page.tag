	...
	type="text/css" rel="stylesheet" class="Telerik_stylesheet" />
		...
		<div>
			...
			<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
				value="/wEPaA8FDzhkNDcwM2Q1MWYwNTBjMRgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnXwQDR89z9PRuhv2/0iz96e6LZgFw==" />
		</div>
		...
		<script src="/resources/Services/PortletProxy.asmx/jsdebug.js"
			type="text/javascript"></script>
		<script src="/resources/Services/ModuleProxy.asmx/jsdebug.js"
			type="text/javascript"></script>
		<script src="/resources/Services/CMS.asmx/jsdebug.js" type="text/javascript"></script>
		<script src="/resources/Services/WeatherService.asmx/jsdebug.js"
			type="text/javascript"></script>
		<div>
      ...
      <link href="/resources/Portlets/MenuRad/Menu.Green.css" rel="stylesheet" type="text/css">
        <div id="ctl06_portlet_800886a8-ccb5-40dd-813a-2c02ac0d2e92_RadMenu" class="RadMenu RadMenu_Green rmSized" style="height: 40px; z-index: 1; width: 100%;">
                <ul class="rmRootGroup rmHorizontal">
                  ...
                  <li class="rmItem " style="z-index: 0;">
                    <a href="/resources/Portlets/MenuRad/#" class="rmLink rmRootLink">
        ...
        <li class="rmItem rmLast">
          <a href="/Default.aspx?ArticleId=b4031ebe-e802-4402-a49a-5769943872a5" class="rmLink rmRootLink">
            <span class="rmText">Contact</span>
          </a>
        </li>
        </ul>
        <input id="ctl06_portlet_800886a8-ccb5-40dd-813a-2c02ac0d2e92_RadMenu_ClientState" name="ctl06_portlet_800886a8-ccb5-40dd-813a-2c02ac0d2e92_RadMenu_ClientState" type="hidden" autocomplete="off">
          </div>
          </div>
        </div>
								</div>
	...
	<div id="slider" class="nivoSlider">
		<div id="pnBottom">
			<div id="pnBottomDisplay"
				style=" margin: auto !importantclear: both; background: url(/resources/Resources/ImagesPortal/PhongBan/bgfooter_phong.png) repeat-x; width: 1000px; height: 110px;">
				<div id="" style="float: right">
					<div>

						<div class="truycap_ute">
							<p>
								Visit month: <span id="">2,525</span>
							</p>
							<p class="line_footer"></p>
							<p>
								Visit total:<span id="">6,003</span>
							</p>
						</div>
